<?php /* Smarty version 2.6.18, created on 2015-08-06 14:11:23
...
/css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Morris chart -->
        <link href="<?php echo $this->_tpl_vars['media_url']; ?>
/css/morris/morris.css" rel="stylesheet" type="text/css" />
        <!-- jvectormap -->
        <link href="<?php echo $this->_tpl_vars['media_url']; ?>
/css/jvectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
        <!-- fullCalendar -->
        <link href="<?php echo $this->_tpl_vars['media_url']; ?>
/css/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css" />
        <!-- Daterange picker -->
        <link href="<?php echo $this->_tpl_vars['media_url']; ?>
/css/daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
        <!-- bootstrap wysihtml5 - text editor -->
        <link href="<?php echo $this->_tpl_vars['media_url']; ?>
/css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        <link href="<?php echo $this->_tpl_vars['media_url']; ?>
...
/images/avatar3.png" class="img-circle" alt="User Image"/>
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo $this->_tpl_vars['media_url']; ?>
/images/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo $this->_tpl_vars['media_url']; ?>
/images/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Developers
...
/images/avatar3.png" class="img-circle" alt="User Image" />
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="/index.php?module=linkPage&action=Widgets">
                        ...
                        <section class="col-lg-6 connectedSortable">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body chat" id="chat-box">
                                    ...
                                    <div class="item">
                                        <img src="<?php echo $this->_tpl_vars['media_url']; ?>
/images/avatar.png" alt="user image" class="online"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <div class="item">
                                        <img src="<?php echo $this->_tpl_vars['media_url']; ?>
/images/avatar2.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <div class="item">
                                        <img src="<?php echo $this->_tpl_vars['media_url']; ?>
/images/avatar3.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
...
/js/jquery-ui-1.10.3.min.js" type="text/javascript"></script>
        <!-- Bootstrap -->
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/bootstrap.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/plugins/morris/morris.min.js" type="text/javascript"></script>
        <!-- Sparkline -->
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/plugins/sparkline/jquery.sparkline.min.js" type="text/javascript"></script>
        <!-- jvectormap -->
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js" type="text/javascript"></script>
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
        <!-- fullCalendar -->
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
        <!-- jQuery Knob Chart -->
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/plugins/jqueryKnob/jquery.knob.js" type="text/javascript"></script>
        <!-- daterangepicker -->
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/plugins/daterangepicker/daterangepicker.js" type="text/javascript"></script>
        <!-- Bootstrap WYSIHTML5 -->
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script>
        <!-- iCheck -->
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
...
/js/AdminLTE/app.js" type="text/javascript"></script>
        ...
        <script src="<?php echo $this->_tpl_vars['media_url']; ?>
/js/AdminLTE/dashboard.js" type="text/javascript"></script>        
